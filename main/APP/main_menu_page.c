...
void main_menu_page(uint32_t delay)
{
    ...
    lv_obj_set_style_bg_color(wifi_menu_btn_obj, lv_color_hex(0x99ccff), 0);
    lv_obj_set_style_bg_opa(wifi_menu_btn_obj, LV_OPA_COVER, 0);
    lv_obj_set_style_bg_color(wifi_menu_btn_obj, lv_color_hex(0x99ccff), LV_STATE_FOCUSED);
    ...
    lv_obj_set_style_text_font(wifi_menu_icon_label, &lv_font_montserrat_16, 0);
